...
while (cap.isOpened()):
    ...
    upper_white = np.array([180, 25, 185])
...
#####################################################################    
   ...
   # print(direccion, "Esta es la dirección")
    ...
    black_upper = np.array([250, 45, 75], np.uint8)
    ...
    for c in contornos:
        ...
        # Obtenemos el bounds del contorno, el rectángulo mayor que engloba al contorno
            ...
            cv2.putText(frame,"RED",(xa+x,ya+y),cv2.FONT_HERSHEY_SIMPLEX,0.7,(0,0,255))
    ...
    for c in contornos:
        ...
        # Obtenemos el bounds del contorno, el rectángulo mayor que engloba al contorno
            ...
            cv2.putText(frame,"BLUE",(xa+x,ya+y),cv2.FONT_HERSHEY_SIMPLEX,0.7,(255,0,0))
    ...
    for c in contornos:
        ...
        # Obtenemos el bounds del contorno, el rectángulo mayor que engloba al contorno
            ...
            cv2.putText(frame,"YELLLOW",(xa+x,ya+y),cv2.FONT_HERSHEY_SIMPLEX,1,(255,0,0))
    ...
    for c in contornos:
        ...
        # Obtenemos el bounds del contorno, el rectángulo mayor que engloba al contorno
            ...
            cv2.putText(frame,"purple",(xa+x,ya+y),cv2.FONT_HERSHEY_SIMPLEX,1,(255,0,0))
    ...
    for c in contornos:
        ...
        # Obtenemos el bounds del contorno, el rectángulo mayor que engloba al contorno
            ...
            cv2.putText(frame,"green",(xa+x,ya+y),cv2.FONT_HERSHEY_SIMPLEX,1,(255,0,0))
    ...
    for c in contornos:
        ...
        # Obtenemos el bounds del contorno, el rectángulo mayor que engloba al contorno
            ...
            cv2.putText(frame,"black",(xa+x,ya+y),cv2.FONT_HERSHEY_SIMPLEX,1,(255,0,0))
    ...
    for c in contornos:
        ...
        # Obtenemos el bounds del contorno, el rectángulo mayor que engloba al contorno
            ...
            cv2.putText(frame,"orange",(xa+x,ya+y),cv2.FONT_HERSHEY_SIMPLEX,1,(255,0,0))
